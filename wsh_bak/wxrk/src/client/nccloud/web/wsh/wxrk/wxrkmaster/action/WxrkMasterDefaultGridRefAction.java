 ...
 * 
 */
public class WxrkMasterDefaultGridRefAction extends DefaultGridRefAction {
	
	public WxrkMasterDefaultGridRefAction() {
		super();
	...
	public RefMeta getRefMeta(RefQueryInfo refQueryInfo) {
		...
		refMeta.setPkField("pk_wxrkmaster");
		refMeta.setTableName("wsh_wxrkmaster");

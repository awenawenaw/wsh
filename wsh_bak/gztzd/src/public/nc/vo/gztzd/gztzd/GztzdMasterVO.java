...
public class GztzdMasterVO extends SuperVO {

	//构造方法
	public GztzdMasterVO() {
		super();
	}
    ...
    private java.lang.String smgztm  ;
    private java.lang.String gztzdcode  ;
    private java.lang.String tzdept  ;
    private java.lang.String tzpon  ;
    private java.lang.String beforestordoc  ;
    private java.lang.String afterstordoc  ;
	...
	public static final String SMGZTM = "smgztm";
	public static final String GZTZDCODE = "gztzdcode";
	public static final String TZDEPT = "tzdept";
	public static final String TZPON = "tzpon";
	public static final String BEFORESTORDOC = "beforestordoc";
	public static final String AFTERSTORDOC = "afterstordoc";
	...
	public void setSmgztm(java.lang.String smgztm){
		this.smgztm = smgztm;
	}

	public java.lang.String getSmgztm(){
		return this.smgztm;
	} 
	
	public void setGztzdcode(java.lang.String gztzdcode){
		this.gztzdcode = gztzdcode;
	}

	public java.lang.String getGztzdcode(){
		return this.gztzdcode;
	} 
	
	public void setTzdept(java.lang.String tzdept){
		this.tzdept = tzdept;
	}

	public java.lang.String getTzdept(){
		return this.tzdept;
	} 
	
	public void setTzpon(java.lang.String tzpon){
		this.tzpon = tzpon;
	}

	public java.lang.String getTzpon(){
		return this.tzpon;
	} 
	
	public void setBeforestordoc(java.lang.String beforestordoc){
		this.beforestordoc = beforestordoc;
	}

	public java.lang.String getBeforestordoc(){
		return this.beforestordoc;
	} 
	
	public void setAfterstordoc(java.lang.String afterstordoc){
		this.afterstordoc = afterstordoc;
	}

	public java.lang.String getAfterstordoc(){
		return this.afterstordoc;
	} 
	...
	@Override
	@nc.vo.annotation.MDEntityInfo(beanFullclassName =  "nc.vo.gztzd.gztzd.GztzdMasterVO" )
	public IVOMeta getMetaData() {
		return VOMetaFactory.getInstance().getVOMeta("gztzd.gztzdMaster");
  	}

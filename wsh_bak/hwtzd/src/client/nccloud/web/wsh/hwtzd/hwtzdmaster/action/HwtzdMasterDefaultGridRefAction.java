 ...
 * 
 */
public class HwtzdMasterDefaultGridRefAction extends DefaultGridRefAction {
	
	public HwtzdMasterDefaultGridRefAction() {
		super();
	...
	public RefMeta getRefMeta(RefQueryInfo refQueryInfo) {
		...
		refMeta.setPkField("pk_hwtzdmaster");
		refMeta.setTableName("wsh_hwtzdmaster");

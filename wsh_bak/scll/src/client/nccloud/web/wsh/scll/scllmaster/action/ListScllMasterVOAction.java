 ...
 * 列表查询
 */
public class ListScllMasterVOAction extends BaseAction{
	...
	public Object doAction(IRequest request, RequstParamWapper paramWapper) throws Throwable{
		...
		//查询当前方案下所有的数据pk
		String[] allpks = service.listScllMasterVOPkByCond(searchSql);
		...
		ScllMasterVO[] vos =  service.listScllMasterVOByPk(curPagePks);
		//构造返回结果

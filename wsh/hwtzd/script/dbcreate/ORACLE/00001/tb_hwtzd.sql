 create table WSH_HWTZDSLAVE0 (def30 varchar2(101) null /*自定义项30*/,
...
znode varchar2(50) null /*备注*/,
adjustnum number(28,8) null /*调整数量*/,
afterrack varchar2(20) null /*调整后货位*/,
beforerack varchar2(20) null /*调整前货位*/,
stordoc varchar2(20) null /*调整仓库*/,
...
pk_hwtzdslave0 char(20) not null /*主键*/,
pk_hwtzdmaster char(20) not null /*上层单据主键*/,
ts char(19) default to_char(sysdate,'yyyy-mm-dd hh24:mi:ss') null /*null*/,
dr integer null /*null*/,
 constraint WSH_HWTZDSLAVE0_PK  primary key (pk_hwtzdslave0)
)

/

 create table WSH_HWTZDMASTER (def30 varchar2(101) null /*自定义项30*/,
def29 varchar2(101) null /*自定义项29*/,
def28 varchar2(101) null /*自定义项28*/,
def27 varchar2(101) null /*自定义项27*/,
def26 varchar2(101) null /*自定义项26*/,
...
dbck varchar2(20) null /*调拨仓库*/,
dbdata char(19) null /*调拨时间*/,
dbpon varchar2(20) null /*调拨人*/,
dbdept varchar2(20) null /*调拨部门*/,
kndbdcode varchar2(50) null /*库内调拨单*/,
...
pk_hwtzdmaster char(20) not null /*主键*/,
ts char(19) default to_char(sysdate,'yyyy-mm-dd hh24:mi:ss') null /*null*/,
dr integer null /*null*/,
 constraint WSH_HWTZDMASTER_PK  primary key (pk_hwtzdmaster)
)

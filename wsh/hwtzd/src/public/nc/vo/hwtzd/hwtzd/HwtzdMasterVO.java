...
public class HwtzdMasterVO extends SuperVO {

	//构造方法
	public HwtzdMasterVO() {
		super();
	}
    ...
    private java.lang.String kndbd_code  ;
    private java.lang.String dbdept  ;
    private java.lang.String dbpon  ;
    private nc.vo.pub.lang.UFDateTime dbdata  ;
    private java.lang.String dbstrdoc  ;
	...
	public static final String KNDBD_CODE = "kndbd_code";
	public static final String DBDEPT = "dbdept";
	public static final String DBPON = "dbpon";
	public static final String DBDATA = "dbdata";
	public static final String DBSTRDOC = "dbstrdoc";
	...
	public void setKndbd_code(java.lang.String kndbd_code){
		this.kndbd_code = kndbd_code;
	}

	public java.lang.String getKndbd_code(){
		return this.kndbd_code;
	} 
	
	public void setDbdept(java.lang.String dbdept){
		this.dbdept = dbdept;
	}

	public java.lang.String getDbdept(){
		return this.dbdept;
	} 
	
	public void setDbpon(java.lang.String dbpon){
		this.dbpon = dbpon;
	}

	public java.lang.String getDbpon(){
		return this.dbpon;
	} 
	
	public void setDbdata(nc.vo.pub.lang.UFDateTime dbdata){
		this.dbdata = dbdata;
	}

	public nc.vo.pub.lang.UFDateTime getDbdata(){
		return this.dbdata;
	} 
	
	public void setDbstrdoc(java.lang.String dbstrdoc){
		this.dbstrdoc = dbstrdoc;
	}

	public java.lang.String getDbstrdoc(){
		return this.dbstrdoc;
	} 
	...
	@Override
	@nc.vo.annotation.MDEntityInfo(beanFullclassName =  "nc.vo.hwtzd.hwtzd.HwtzdMasterVO" )
	public IVOMeta getMetaData() {
		return VOMetaFactory.getInstance().getVOMeta("hwtzd.hwtzdMaster");
  	}

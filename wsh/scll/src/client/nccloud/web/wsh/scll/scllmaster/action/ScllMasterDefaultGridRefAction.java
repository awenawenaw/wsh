 ...
 * 
 */
public class ScllMasterDefaultGridRefAction extends DefaultGridRefAction {
	
	public ScllMasterDefaultGridRefAction() {
		super();
	...
	public RefMeta getRefMeta(RefQueryInfo refQueryInfo) {
		...
		refMeta.setPkField("pk_scllmaster");
		refMeta.setTableName("wsh_scllmaster");

 create table WSH_CLQRSLAVE0 (def30 varchar2(101) null /*自定义项30*/,
...
pk_llqrmaster char(20) not null /*上层单据主键*/,
pk_llqrslave0 char(20) not null /*主键*/,
ts char(19) default to_char(sysdate,'yyyy-mm-dd hh24:mi:ss') null /*null*/,
dr integer null /*null*/,
 constraint WSH_CLQRSLAVE0_PK  primary key (pk_llqrslave0)
)

/

 create table WSH_CLQRMASTER (def30 varchar2(101) null /*自定义项30*/,
def29 varchar2(101) null /*自定义项29*/,
def28 varchar2(101) null /*自定义项28*/,
def27 varchar2(101) null /*自定义项27*/,
def26 varchar2(101) null /*自定义项26*/,
...
flpon varchar2(20) null /*发料人*/,
scddcode varchar2(50) null /*生产订单号*/,
sclldcode varchar2(50) null /*生产领料单号*/,
gyjcdtm varchar2(50) null /*扫描工艺进程单条码*/,
...
pk_llqrmaster char(20) not null /*主键*/,
ts char(19) default to_char(sysdate,'yyyy-mm-dd hh24:mi:ss') null /*null*/,
dr integer null /*null*/,
 constraint WSH_CLQRMASTER_PK  primary key (pk_llqrmaster)
)

...
public class DbrkdMasterVO extends SuperVO {

	//构造方法
	public DbrkdMasterVO() {
		super();
	}
    ...
    private java.lang.String rkr  ;
    private nc.vo.pub.lang.UFDateTime rksj  ;
    private java.lang.String rkck  ;
	...
	public static final String RKR = "rkr";
	public static final String RKSJ = "rksj";
	public static final String RKCK = "rkck";
	...
	public void setRkr(java.lang.String rkr){
		this.rkr = rkr;
	}

	public java.lang.String getRkr(){
		return this.rkr;
	} 
	
	public void setRksj(nc.vo.pub.lang.UFDateTime rksj){
		this.rksj = rksj;
	}

	public nc.vo.pub.lang.UFDateTime getRksj(){
		return this.rksj;
	} 
	
	public void setRkck(java.lang.String rkck){
		this.rkck = rkck;
	}

	public java.lang.String getRkck(){
		return this.rkck;
	} 
	...
	@Override
	@nc.vo.annotation.MDEntityInfo(beanFullclassName =  "nc.vo.dbrkd.dbrkd.DbrkdMasterVO" )
	public IVOMeta getMetaData() {
		return VOMetaFactory.getInstance().getVOMeta("dbrkd.dbrkdMaster");
  	}

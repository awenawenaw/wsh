 ...
 * 列表查询
 */
public class ListDbrkdMasterVOAction extends BaseAction{
	...
	public Object doAction(IRequest request, RequstParamWapper paramWapper) throws Throwable{
		...
		//查询当前方案下所有的数据pk
		String[] allpks = service.listDbrkdMasterVOPkByCond(searchSql);
		...
		DbrkdMasterVO[] vos =  service.listDbrkdMasterVOByPk(curPagePks);
		//构造返回结果

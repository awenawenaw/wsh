...
public class ZkdwxMasterVO extends SuperVO {

	//构造方法
	public ZkdwxMasterVO() {
		super();
	}


    private java.lang.String pk_zkdwxmaster  ;
    ...
    private java.lang.String ck_stordoc  ;
    private java.lang.String rk_stordoc  ;
    private java.lang.String zklx  ;
    private java.lang.String ck_psndoc  ;
    private java.lang.String ck_cept  ;
    private java.lang.String rk_psndoc  ;
    private java.lang.String rk_cept  ;
    private nc.vo.pub.lang.UFDateTime yfhdata  ;
    private nc.vo.pub.lang.UFDateTime ydhdata  ;
	...
	public static final String PK_ZKDWXMASTER = "pk_zkdwxmaster";
	...
	public static final String CK_STORDOC = "ck_stordoc";
	public static final String RK_STORDOC = "rk_stordoc";
	public static final String ZKLX = "zklx";
	public static final String CK_PSNDOC = "ck_psndoc";
	public static final String CK_CEPT = "ck_cept";
	public static final String RK_PSNDOC = "rk_psndoc";
	public static final String RK_CEPT = "rk_cept";
	public static final String YFHDATA = "yfhdata";
	public static final String YDHDATA = "ydhdata";
	...
	public void setPk_zkdwxmaster(java.lang.String pk_zkdwxmaster){
		this.pk_zkdwxmaster = pk_zkdwxmaster;
	}

	public java.lang.String getPk_zkdwxmaster(){
		return this.pk_zkdwxmaster;
	} 
	...
	public void setCk_stordoc(java.lang.String ck_stordoc){
		this.ck_stordoc = ck_stordoc;
	}

	public java.lang.String getCk_stordoc(){
		return this.ck_stordoc;
	} 
	
	public void setRk_stordoc(java.lang.String rk_stordoc){
		this.rk_stordoc = rk_stordoc;
	}

	public java.lang.String getRk_stordoc(){
		return this.rk_stordoc;
	} 
	
	public void setZklx(java.lang.String zklx){
		this.zklx = zklx;
	}

	public java.lang.String getZklx(){
		return this.zklx;
	} 
	
	public void setCk_psndoc(java.lang.String ck_psndoc){
		this.ck_psndoc = ck_psndoc;
	}

	public java.lang.String getCk_psndoc(){
		return this.ck_psndoc;
	} 
	
	public void setCk_cept(java.lang.String ck_cept){
		this.ck_cept = ck_cept;
	}

	public java.lang.String getCk_cept(){
		return this.ck_cept;
	} 
	
	public void setRk_psndoc(java.lang.String rk_psndoc){
		this.rk_psndoc = rk_psndoc;
	}

	public java.lang.String getRk_psndoc(){
		return this.rk_psndoc;
	} 
	
	public void setRk_cept(java.lang.String rk_cept){
		this.rk_cept = rk_cept;
	}

	public java.lang.String getRk_cept(){
		return this.rk_cept;
	} 
	
	public void setYfhdata(nc.vo.pub.lang.UFDateTime yfhdata){
		this.yfhdata = yfhdata;
	}

	public nc.vo.pub.lang.UFDateTime getYfhdata(){
		return this.yfhdata;
	} 
	
	public void setYdhdata(nc.vo.pub.lang.UFDateTime ydhdata){
		this.ydhdata = ydhdata;
	}

	public nc.vo.pub.lang.UFDateTime getYdhdata(){
		return this.ydhdata;
	} 
	...
	@Override
	@nc.vo.annotation.MDEntityInfo(beanFullclassName =  "nc.vo.zkdwx.zkdwx.ZkdwxMasterVO" )
	public IVOMeta getMetaData() {
		return VOMetaFactory.getInstance().getVOMeta("zkdwx.zkdwxMaster");
  	}

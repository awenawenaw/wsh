 ...
 * 列表查询
 */
public class ListQcysdgxwxMasterVOAction extends BaseAction{
	...
	public Object doAction(IRequest request, RequstParamWapper paramWapper) throws Throwable{
		...
		//查询当前方案下所有的数据pk
		String[] allpks = service.listQcysdgxwxMasterVOPkByCond(searchSql);
		...
		QcysdgxwxMasterVO[] vos =  service.listQcysdgxwxMasterVOByPk(curPagePks);
		//构造返回结果

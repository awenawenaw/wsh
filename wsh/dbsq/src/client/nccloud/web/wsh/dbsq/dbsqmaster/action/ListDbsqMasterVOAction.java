 ...
 * 列表查询
 */
public class ListDbsqMasterVOAction extends BaseAction{
	...
	public Object doAction(IRequest request, RequstParamWapper paramWapper) throws Throwable{
		...
		//查询当前方案下所有的数据pk
		String[] allpks = service.listDbsqMasterVOPkByCond(searchSql);
		...
		DbsqMasterVO[] vos =  service.listDbsqMasterVOByPk(curPagePks);
		//构造返回结果
